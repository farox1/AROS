    ...
    APTR srcbuff, ULONG srcpitch, LONG destX, LONG destY, LONG width, LONG height)
{
    ...
    for (y = 0; y < height; y++)
    {
        ...
        IPTR destaddr = (destX * 4) + (bmdata->pitch * (destY + y)) + (IPTR)BM_VIRTUAL(bmdata);
    ...
    APTR srcbuff, ULONG srcpitch, LONG destX, LONG destY, LONG width, LONG height)
{
    ...
    {
        IPTR srcaddr = (srcpitch * y) + (IPTR)srcbuff;
        IPTR destaddr = (destX * 2) + (bmdata->pitch * (destY + y)) + (IPTR)BM_VIRTUAL(bmdata);
    ...
    UBYTE *srcalpha, ULONG srcpitch, LONG destX, LONG destY, LONG width, LONG height)
{
    ...
    for (y = 0; y < height; y++)
    {
        IPTR destaddr = (destX * 4) + ((destY + y) * bmdata->pitch) + (IPTR)BM_VIRTUAL(bmdata);
    ...
    UBYTE *srcalpha, ULONG srcpitch, LONG destX, LONG destY, LONG width, LONG height)
{
    ...
    for (y = 0; y < height; y++)
    {
        IPTR destaddr = (destX * 2) + ((destY + y) * bmdata->pitch) + (IPTR)BM_VIRTUAL(bmdata);
