...
/* PCI-based DRM initialization for Intel (placeholder for i915 kernel driver) */
int intel_drm_pci_init()
{
    ...
    /* FIXME: Open DRM device and initialize i915 driver */
    // if (i915_drm_probe(pdev, &dummy, &current_drm_device))
    //    return -1;
