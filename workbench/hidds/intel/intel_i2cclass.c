...
#undef HiddI2CIntelAttrBase
#define HiddI2CIntelAttrBase (SD(cl)->i2cIntelAttrBase)

OOP_Object *METHOD(IntelI2C, Root, New)
{
    o = (OOP_Object *)OOP_DoSuperMethod(cl, o, (OOP_Msg)msg);
    
    if (o)
    {
        struct HIDDIntelI2CData *i2cdata = OOP_INST_DATA(cl, o);
        
        i2cdata->i2c_adapter = GetTagData(aHidd_I2C_Intel_Adapter, (IPTR)0, msg->attrList);
